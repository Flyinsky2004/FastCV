...
<template>
  ...
  >
    <div
      class="h-10 bg-white shadow-md shadow-gray-400 place-items-center flex"
    >
      <div
        class="font-bold text-xl flex-grow text-center title bg-clip-text bg-gradient-to-r from-purple-500 via-red-500 to-pink-500 text-transparent select-none cursor-pointer"
        @click="router.push('/')"
      >
        FastCV
      </div>
