...
<template>
  ...
  <div class="bg-white">
    <div class="grid grid-cols-[1fr,1fr,1fr] bg-[rgb(128,145,165)] text-white">
      <!--       主要个人资料-->
      <div class="grid grid-cols-1 place-items-center">
        ...
        <div class="grid grid-cols-1 gap-4 place-items-center">
          ...
          <div class="flex place-items-center text-white ">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
        ...
        <div class="grid grid-cols-3 place-items-center gap-4">
          <div v-if="options.profile.webSite" class="flex flex-nowrap text-white  place-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
              <path stroke-linecap="round" stroke-linejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
            </svg>
            <a :href="options.profile.webSite">个人网站</a>
          </div>
          <div v-if="options.profile.github" class="flex flex-nowrap text-white  place-items-center">
            <img class="bg-white rounded-xl" width="20" :src="github">
            <a :href="options.profile.github">Github</a>
          </div>
          <div v-if="options.profile.webSite" class="flex flex-nowrap text-white-500  place-items-center">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
      ...
      <div class="flex p-10 justify-center bg-[#5a6d83]">
        <div class="flex justify-center justify-items-center w-36 h-36 bg-white rounded-full place-items-center">
          <img class="w-32 h-32 my-auto rounded-full" :src="options.profile.avatar">
        </div>
      </div>
    </div>
    <div class="grid grid-cols-[2fr,50fr] mt-2">
      <div class="flex justify-center bg-[#7e90a5] place-items-center">
        <svg xmlns="http://www.w3.org/2000/svg" fill="#f6de74" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
          <path stroke-linecap="round" stroke-linejoin="round" d="M11.48 3.499a.562.562 0 0 1 1.04 0l2.125 5.111a.563.563 0 0 0 .475.345l5.518.442c.499.04.701.663.321.988l-4.204 3.602a.563.563 0 0 0-.182.557l1.285 5.385a.562.562 0 0 1-.84.61l-4.725-2.885a.562.562 0 0 0-.586 0L6.982 20.54a.562.562 0 0 1-.84-.61l1.285-5.386a.562.562 0 0 0-.182-.557l-4.204-3.602a.562.562 0 0 1 .321-.988l5.518-.442a.563.563 0 0 0 .475-.345L11.48 3.5Z" />
        </svg>
      </div>
      <div class="bg-gray-200 p-1 text-xl font-bold text-[#7e90a5]">
        工作经历
      </div>
    </div>
