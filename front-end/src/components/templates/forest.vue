...
<template>
  ...
  <div class="bg-white">
    <div class="grid grid-cols-[3fr,7fr]">
      <div class="bg-[#4f7a83] text-white p-1">
        <div class="flex p-10">
          <img class="w-36 h-36 my-auto" :src="options.profile.avatar">
        </div>
        <div>
          <h1 class="text-2xl font-bold">关于我</h1>
          <div class="grid grid-cols-1 gap-4 place-items-start">
            ...
            <div v-if="options.profile.webSite" class="flex flex-nowrap   place-items-center">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                   stroke="currentColor" class="size-5">
                <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <div v-if="options.profile.github" class="flex flex-nowrap  place-items-center">
        ...
        <!--        <div>-->
        <!--          <h1 class="text-2xl font-bold">个人技能</h1>-->
        <!--          <div v-for="skill in options.profile.skills" class="w-fit">-->
        <!--            <div class="font-bold mt-2 w-full">-->
        <!--              {{ skill.title }}-->
        <!--            </div>-->
        <!--          </div>-->
        <!--        </div>-->
      ...
      <div class="grid grid-cols-1 mt-2 p-2">
        ...
        <div class="bg-[#6ba0ac] text-xl font-bold text-white p-1 w-fit h-fit">
          教育背景
        </div>
        <div v-for="edu in options.profile.education" class="mt-2">
          <div class="font-bold grid grid-cols-[1fr,1fr,1fr]">
        ...
        <div v-for="exp in options.profile.workExperience" class="mt-2">
          <div class="grid grid-cols-[3fr,5fr,3fr]">
